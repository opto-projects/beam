...
#include "windows/messageconsole.h"
...
#define M_ Ori::Gui::menu
    ...
    m->addAction(QIcon(":/ori_images/help"), tr("Help"), help, &HelpSystem::showContent, QKeySequence::HelpContents);
...
void PlotWindow::createDockPanel()
{
    ...
    _msgConsole = new MessageConsole(this);
    _msgConsoleDock = new QDockWidget((tr("Message Console")), this);
    _msgConsoleDock->setObjectName("MessageConsole");
    this->_msgConsoleDock->setFloating(false);
    this->_msgConsoleDock->setVisible(true);
    _msgConsoleDock->setWidget(_msgConsole);
    addDockWidget(Qt::BottomDockWidgetArea, _msgConsoleDock);
    //this->_msgConsoleDock->setTitleBarWidget(new QWidget()); //this removes title bar
}
