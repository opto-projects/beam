...
void RoiRectGraph::makeEditor()
{
    ...
    connect(_seX1, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged), this, [this](int v){
        if ((int)_x1 == v) return;
        _x1 = v;
        _seW->setValue(roiW());
        parentPlot()->replot();
    });
    connect(_seX2, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged), this, [this](int v){
        if ((int)_x2 == v) return;
        _x2 = v;
        _seW->setValue(roiW());
        parentPlot()->replot();
    });
    connect(_seY1, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged), this, [this](int v){
        if ((int)_y1 == v) return;
        _y1 = v;
        _seH->setValue(roiH());
        parentPlot()->replot();
    });
    connect(_seY2, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged), this, [this](int v){
        if ((int)_y2 == v) return;
        _y2 = v;
        _seH->setValue(roiH());
        parentPlot()->replot();
    ...
    if (1/*qApp->styleHints()->colorScheme() == Qt::ColorScheme::Dark*/)
