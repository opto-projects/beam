...
public:
    MesureSaverDlg(const MeasureConfig &cfg) {
        ...
        labDuration->setForegroundRole(1/*qApp->styleHints()->colorScheme() == Qt::ColorScheme::Dark*/ ? QPalette::Light : QPalette::Mid);
        ...
        labImgInterval->setForegroundRole(1/*qApp->styleHints()->colorScheme() == Qt::ColorScheme::Dark*/ ? QPalette::Light : QPalette::Mid);
