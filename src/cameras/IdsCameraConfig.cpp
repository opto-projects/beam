...
public:
    ConfigEditorFactorXY(IdsCameraConfig::FactorXY *factor, ConfigEditorFactorXY *other) : ConfigItemEditor(), factor(factor), other(other)
    {
        ...
        connect(comboX, QOverload<int>::of(&QComboBox::activated), this, &ConfigEditorFactorXY::updateOther);
        connect(comboY, QOverload<int>::of(&QComboBox::activated), this, &ConfigEditorFactorXY::updateOther);
...
void IdsCameraConfig::initDlg(cv::VideoCapture* hCam, Ori::Dlg::ConfigDlgOpts &opts, int maxPageId)
{
    ...
    if (!intoRequested) {
        intoRequested = true;
        infoModelName = "DeviceModelName";
        infoFamilyName ="DeviceFamilyName";
        infoSerialNum =  "DeviceSerialNumber";
        infoVendorName =  "DeviceVendorName";
        infoManufacturer =  "DeviceManufacturerInfo";
        infoDeviceVer =  "DeviceVersion";
        infoFirmwareVer =  "DeviceFirmwareVersion";
    }
